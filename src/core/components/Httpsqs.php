...
$httpsqs = new httpsqs($httpsqs_host, $httpsqs_port, $auth, $httpsqs_charset);
...
class Httpsqs extends Component
{
    ...
    {
        $result = $this->http_post("/?auth=".$this->auth."&charset=".$this->charset."&name=".$queue_name."&opt=put", $queue_data);
    ...
    {
        $result = $this->http_get("/?auth=".$this->auth."&charset=".$this->charset."&name=".$queue_name."&opt=get");
    ...
    {
        $result = $this->http_get("/?auth=".$this->auth."&charset=".$this->charset."&name=".$queue_name."&opt=status");
        if ($result == false || $result["data"] == "HTTPSQS_ERROR" || $result["data"] == false) {
            return false;
        }
        return $result["data"];
    ...
    {
        $result = $this->http_get("/?auth=".$this->auth."&charset=".$this->charset."&name=".$queue_name."&opt=view&pos=".$queue_pos);
        if ($result == false || $result["data"] == "HTTPSQS_ERROR" || $result["data"] == false) {
            return false;
        }
        return $result["data"];
    ...
    {
        $result = $this->http_get("/?auth=".$this->auth."&charset=".$this->charset."&name=".$queue_name."&opt=reset");
    ...
    {
        $result = $this->http_get("/?auth=".$this->auth."&charset=".$this->charset."&name=".$queue_name."&opt=maxqueue&num=".$num);
    ...
    {
        $result = $this->http_get("/?auth=".$this->auth."&charset=".$this->charset."&name=".$queue_name."&opt=status_json");
        if ($result == false || $result["data"] == "HTTPSQS_ERROR" || $result["data"] == false) {
            return false;
        }
        return $result["data"];
    ...
    {
        $result = $this->http_get("/?auth=".$this->auth."&charset=".$this->charset."&name=httpsqs_synctime&opt=synctime&num=".$num);
